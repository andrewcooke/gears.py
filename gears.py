...
TEST3X11 = Bike("27.5\" 3x11 11-42", "red", CRINGXT223040, CSTXT1142, 27.5)
TEST2X11L = Bike("27.5\" 2x11 24-34 11-42", "green", CRINGXT2434, CSTXT1142, 27.5)
TEST2X11M = Bike("27.5\" 2x11 26-36 11-42", "green", CRINGXT2636, CSTXT1142, 27.5)
TEST2X11H = Bike("27.5\" 2x11 28-38 11-42", "green", CRINGXT2838, CSTXT1142, 27.5)

# plot the bikes

plot(MYBIKE, TEST3X11, TEST2X11L)
